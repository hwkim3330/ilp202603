...
export const ROII_REAL_NODE_COLORS = {
  // LiDAR G32 FC — bright green
  LIDAR_FC:  { fill: "#d1fae5", stroke: "#10B981", label: "G32 FC",       shortLabel: "G32" },
  // LiDAR G32 Rear — gray
  LIDAR_R:   { fill: "#e5e7eb", stroke: "#6B7280", label: "G32 Rear",     shortLabel: "G32" },
  // LiDAR Pandar FL — orange
  LIDAR_FL:  { fill: "#ffedd5", stroke: "#F97316", label: "Pandar FL",    shortLabel: "P40P" },
  // LiDAR Pandar FR — blue
  LIDAR_FR:  { fill: "#dbeafe", stroke: "#3B82F6", label: "Pandar FR",    shortLabel: "P40P" },
  // Radar MRR-35 — purple
...
export function realFlowColor(fid) {
  ...
  if (id.includes('lidar_fl')) return '#F97316';
  if (id.includes('lidar_fr')) return '#3B82F6';
  if (id.includes('lidar_r') && !id.includes('lidar_rc')) return '#6B7280';
...
export const ROII_REAL_STANDARD_SCENARIO = {
  ...
  flows: [
    ...
    { name: "Pandar FL \u2192 ACU-IT",   color: "#F97316", desc: "32KB sub-sampled, P7, 1Gbps (262.4\u00b5s tx)" },
    { name: "Pandar FR \u2192 ACU-IT",   color: "#3B82F6", desc: "32KB sub-sampled, P7, 1Gbps (262.4\u00b5s tx)" },
    { name: "G32 Rear \u2192 ACU-IT",    color: "#6B7280", desc: "128KB point cloud, P7, 1Gbps (1048.9\u00b5s tx)" },
  ...
  domains: [
    { name: "LiDAR G32 FC (1Gbps)",     color: "#10B981" },
    { name: "LiDAR G32 Rear (1Gbps)",   color: "#6B7280" },
    { name: "LiDAR Pandar FL (1Gbps)",  color: "#F97316" },
    { name: "LiDAR Pandar FR (1Gbps)",  color: "#3B82F6" },
...
export const ROII_OPTIMAL_SCENARIO = {
  ...
  flows: [
    ...
    { name: "Pandar FL \u2192 SW_FL \u2192 ACU-IT",  color: "#F97316", desc: "32KB, P7, 2 hops (262.4\u00b5s tx/hop)" },
    { name: "Pandar FR \u2192 SW_FR \u2192 ACU-IT",  color: "#3B82F6", desc: "32KB, P7, 2 hops (262.4\u00b5s tx/hop)" },
    { name: "G32 Rear \u2192 SW_REAR \u2192 ACU-IT", color: "#6B7280", desc: "128KB, P7, 2 hops (1048.9\u00b5s tx/hop)" },
...
export const ROII_REAL_8TC = {
  ...
  flows: [
    ...
    { id: "f_lidar_fc", PCP: 7, payload_bytes: 1276, period_us: 200, deadline_us: 1000,
      traffic_type: "lidar", src: "LIDAR_FC", dst: "ACU_IT", k_paths: 2 },
    { id: "f_lidar_r",  PCP: 4, payload_bytes: 1276, period_us: 500, deadline_us: 1000,
      traffic_type: "lidar", src: "LIDAR_R",  dst: "ACU_IT", k_paths: 2 },
    ...
    { id: "f_lidar_fl", PCP: 6, payload_bytes: 1290, period_us: 250, deadline_us: 1000,
      traffic_type: "lidar", src: "LIDAR_FL", dst: "ACU_IT", k_paths: 2 },
    { id: "f_lidar_fr", PCP: 5, payload_bytes: 1290, period_us: 500, deadline_us: 1000,
      traffic_type: "lidar", src: "LIDAR_FR", dst: "ACU_IT", k_paths: 2 },
...
export const ROII_8TC_SCENARIO = {
  ...
  flows: [
    ...
    { name: "G32 Rear \u2192 ACU-IT",    color: "#6B7280", desc: "1276B, PCP 6, 200\u00b5s period (10.512\u00b5s TX)" },
    { name: "Pandar FL \u2192 ACU-IT",   color: "#F97316", desc: "1290B, PCP 5, 500\u00b5s period (10.624\u00b5s TX)" },
    { name: "Pandar FR \u2192 ACU-IT",   color: "#3B82F6", desc: "1290B, PCP 4, 500\u00b5s period (10.624\u00b5s TX)" },
  ...
  domains: [
    { name: "AutoL G32 FC (PCP 7)",        color: "#10B981" },
    { name: "AutoL G32 Rear (PCP 6)",     color: "#6B7280" },
    { name: "Hesai Pandar FL (PCP 5)",    color: "#F97316" },
    { name: "Hesai Pandar FR (PCP 4)",    color: "#3B82F6" },
